...
import (
	"cmos.chinamobile.com/ip-fixed/controllers/ippool"
	"cmos.chinamobile.com/ip-fixed/controllers/iprecorder"
	"flag"
	"net/http"
	"os"
...
func init() {
	...
	_ = ipfixedv1alpha1.AddToScheme(scheme)
	// add manully
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:   "9051ed5e.cmos.chinamobile.com",
	})
	if err != nil {
	...
	if err = (&iprecorder.IPRecorderReconciler{
		Client: mgr.GetClient(),
		Log:    ctrl.Log.WithName("controllers").WithName("IPRecorder"),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "IPRecorder")
		os.Exit(1)
	}
